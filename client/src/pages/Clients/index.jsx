        ...
        <table>
          <thead>
            <tr>
              ...
              <th>Country</th>
              <th>
                <abbr title="URL to Xero for this client">Xero</abbr>
              </th>
              <th>
                <abbr title="Number of active jobs">Active jobs</abbr>
              </th>
              <th>
                <abbr title="Number of completed jobs">Completed jobs</abbr>
              </th>
              <th>
            ...
            {this.state.clients.map((client, i) => {
              return (
                <tr key={i}>
                  ...
                  <td>
                    {client.xeroId !== undefined ? (
                      <a
                        target="_blank"
                        href={`https://go.xero.com/Contacts/View/${client.xeroId}`}
                      >
                        View in Xero
                      </a>
                    ) : (
